...
from prompt_gan import PromptEnhancementGenerator
...
if __name__ == "__main__":
    ...
    parser.add_argument("--gan_model_path", type=str,
                        default='F:/PyCharmProjects/SeeSR/preset/models/prompt_gan/select/generator_epoch_100.pth')
    parser.add_argument("--vocabulary_path", type=str, default="C:/Users/C/SeeSR/lexicon.json",
